...
public class DisplayCheckerState {
    ...
    public void setWeatherConditionOptions(String weatherConditionOptions) {
        this.weatherConditionOptions = weatherConditionOptions;
    }

    public void setStartChecking(int startChecking) {
        this.startChecking = startChecking;
    }

    public void setStopChecking(int stopChecking) {
        this.stopChecking = stopChecking;
    }

    public void setMessage(String nonexist) {
        this.message = nonexist;
    }
}
